...
LevelChosenState::LevelChosenState(std::shared_ptr<Game> game) : LevelState(game)
{
    ...
    auto MarioNameMessage = helperBuilder::makeCanActiveText("Mario", sf::Vector2f(UIConstant::ws.x * 0.35f, sameHeightStat - 10.0f),
                                                             60, UIFont, marionameColorSetting, true);

    auto LuigiNameMessage = helperBuilder::makeCanActiveText("Luigi", sf::Vector2f(UIConstant::ws.x * 0.85f, sameHeightStat - 10.0f),
                                                             60, UIFont, luiginameColorSetting, true);
    ...
    auto RedMarioBtn = makeButtonUtil(
        ...
        [MarioNameMessage]()
        {
            ...
            LevelManager::instance().setMarioIsChosen(true);
        },
    ...
    auto GreenMarioBtn = makeButtonUtil(
        ...
        [LuigiNameMessage]()
        {
            ...
            LevelManager::instance().setMarioIsChosen(false);
        },
