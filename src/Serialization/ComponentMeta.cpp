...
DEFINE_COMPONENT(TeleChanneling, teleInTime, teleEntity, beforeActualTele)
...
DEFINE_COMPONENT(BounceBlockTag, originalY, bounceVel)

#include <Gameplay/Block/Components.hpp>
DEFINE_TAG(CoinBlockTag)
DEFINE_TAG(GroundBlockTag)
DEFINE_TAG(LevelUpBlockTag)
DEFINE_TAG(NormalBlockTag)
DEFINE_TAG(StairsBlockTag)
DEFINE_TAG(StarBlockTag)
DEFINE_TAG(CoinQuestionBlockTag)
DEFINE_TAG(FlowerQuestionBlockTag)
DEFINE_TAG(MushroomQuestionBlockTag)
DEFINE_TAG(StarQuestionBlockTag)
DEFINE_TAG(FlagBlockTag)
DEFINE_TAG(QuestionBlockTag)
DEFINE_COMPONENT(CoinBlockComponent, waitingTime, timer, hitCount, isCollected, firstTime)
DEFINE_TAG(MushroomBlockTag)
DEFINE_TAG(Level1BlockTag)
DEFINE_TAG(Level2BlockTag)
DEFINE_TAG(Level3BlockTag)
DEFINE_TAG(Level4BlockTag)
...
DEFINE_COMPONENT(Animation, sprite, frameWidth, frameHeight, frameCount, frameDuration, currentFrame, timer, loop, row, hasEnded, textures, shouldRepeat)
DEFINE_TAG(FlipXTag)
DEFINE_TAG(FlipYTag)
